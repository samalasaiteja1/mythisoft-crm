...
export default function MilestonesGuideBanner() {
  return (
    <div className="card border-cyan-500/20 bg-cyan-500/5 text-xs lg:text-sm">
      <p className="text-white font-medium mb-2">Milestones vs tasks — pick a project first</p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 lg:gap-3 text-gray-400">
        <div className="flex gap-2">
          <Flag size={14} lg:size={16} className="text-cyan-400 shrink-0 mt-0.5" />
          <span>
        ...
        <div className="flex gap-2">
          <ListTodo size={14} lg:size={16} className="text-violet-400 shrink-0 mt-0.5" />
          <span>
